...
import {ChmToken} from "../src/tokens/ChmToken.sol";
...
import {AllocationAddresses} from "../src/utils/Structs.sol";
import {ChmBaseToken} from "../src/tokens/ChmBaseToken.sol";
...
contract ChmTokenTest is Test {
    ...
    //     vm.expectRevert(ChmBaseToken.ZeroAddressNotAllowed.selector);
